    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center py-32">
        ...
        <div className="flex flex-col items-center gap-3 mb-10">
          <p className="text-slate-400 text-sm font-semibold tracking-widest uppercase">Check my digital work</p>
          <a
            href="https://www.linkedin.com/in/dr-mahmoud-abo-obiaa-b553412aa/"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 px-8 py-4 rounded-full glass border border-blue-500/30 text-blue-300 hover:text-white hover:border-blue-400/60 text-lg font-semibold transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-500/20"
          >
